...
public class MyPapers extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getSession().getAttribute("loggedIn") != null)   {
          ...
          myPapers = PaperFactory.getInstance().getPapersByAuthor(user);      // aggiorno la lista degli articoli dell'autore
          request.setAttribute("papers", myPapers);   // aggiorno attributo di sessione
